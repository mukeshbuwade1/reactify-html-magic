...
export const whatWeOffer =[
  {
    ...
    info:"Get the best travel deals at unbeatable prices without compromising on quality."
  },
  {
    id:2,
    icon: faTrophy,
    heading:"Best Services",
    info:"Enjoy hassle-free travel with our expert support, premium packages, and customer-first approach"
  },
  {
    id:3,
    icon: faGlobeAmericas,
    heading:"Worldwide Coverage",
    info:"Explore destinations across the globe with our extensive travel network and services"
  },
  {
    id:1,
    icon: faSuitcase,
    heading:"Tailored Travel Packages",
    info:"Enjoy all-inclusive resorts or cultural tours tailored to your preferences, budget, and schedule."
  },
  {
    id:1,
    icon: faUserTie,
    heading:"Expert Guidance",
    info:"Get expert travel advice and hassle-free planning from our experienced team."
  },
  {
    id:1,
    icon: faUsers,
    heading:"Group and Private Tours",
    info:"Choose group or private tours for a personalized experience with expert local guides"
  },
  {
    id:1,
    icon: faCalendarCheck,
    heading:"Easy Booking Process",
    info:"Book your dream trip easily with our user-friendly tools and assistant, all in one place."
  },
  {
    id:1,
    icon: faHeadset,
